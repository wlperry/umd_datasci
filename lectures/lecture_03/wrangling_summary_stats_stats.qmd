...
order: 3                 # position within its week (or overall, your choice)
week: 2                  # which week block it belongs to on the homepage
type: lecture             # lecture | activity | homework | assignment | common_code
description: >
  Filter, select, mutate, and arrange with the tidyverse pipe; compute
  mean, median, variance, SD, and SE; start comparing groups.
