# =============================================================================
# Homework 07 — Is Your City Warming? A Climate Regression Comparison
...
#
# Reference: Lecture 07 (downloading + summarizing climate data),
#            Worksheet 07 (regression + summer/winter case_when)
# =============================================================================


# ── STEP 1: Load packages ─────────────────────────────────────────────────────
# Put ALL library() calls here at the top of the script (see Lecture 02, 07)
...
# Same function as Lecture 07 — just a different station ID and year range
...
# Same select() pattern as Lecture 07 / Worksheet 07
...
# group_by() + summarize() — same pattern as Worksheet 07 Part 5
...
# Same plot structure as Lecture 07 yearly_temp_plot
...
# Same lm() syntax as Lecture 07 / Worksheet 07 Part 6
...
# Use your Duluth warming rate from Worksheet 07 (fill in the number you found)

duluth_decade_rate <- _____    # paste in Duluth's °C/decade rate from Worksheet 07
...
# Q12 — Duluth's warming rate (°C/decade), from Worksheet 07: _______
...
# (only run this if you still have dlh_year_df from Worksheet 07 in your environment)
#
...
# Same pattern as Lecture 07 / Worksheet 07 Part 7
...
# Same plot structure as Lecture 07 season_temp_plot
...
# Same pattern as Lecture 07 / Worksheet 07 Part 10
...
# city_winter_model, and your Worksheet 07 Duluth results
...
# Submit to Canvas:
#   1. This script (your_city_skeleton.R) — with all Q# blanks filled
