...
type: activity
description: >
  Hands-on companion to the mapping lecture. Over two days students load 4,500+
...
and save it into your project's `data/` folder. It has ~4,586 sightings with `latitude`, `longitude`, `state`, `season`, and `classification`.
