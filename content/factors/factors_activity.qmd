...
order: 10
week: 5
title: "Worksheet 10 — Factors: Ordering and Cleaning Categorical Data"
...
> 💡 **Key idea:** a factor is stored as integer **codes** with a labels table. `as.numeric()` returns the codes — always go through `as.character()` first when a factor holds real numbers.
