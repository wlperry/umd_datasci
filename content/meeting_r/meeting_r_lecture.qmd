...
description: >
  How to we make projects that are repeatable and organize the chaos into structure and how to use R and Posiotron.
...
::: {.column width="40%"}
![](images/diagram_ggplot_layers.png){width="55%"}
:::
::::::
...
::: {.column width="40%"}
![](images/diagram_assignment.png){width="55%"}
:::
::::::
...
![](images/diagram_function.png){width="55%"}
:::::
...
::: {.column width="40%"}
![](images/diagram_datatypes.png){width="55%"}
:::
::::::
...
::: {.column width="40%"}
![](images/diagram_dataframe.png){width="55%"}
:::
::::::
...
:::: {.column width="40%"}
![](images/diagram_pipe.png){width="55%"}
...
- `+` at the start = error
- AND YES - Totally confusing to have %\>% for code and + for plots - but its the way it is....
:::
::::
...
`ggsave()` wants the **filename first** or use `file = plot` then `plot =`. Also: `dpi = 300` is publication quality — always use it.
:::
::::

:::: {.column width="40%"}
::: callout-note
![](images/paste-3.png){width="55%"}
:::
::::
:::::::
...
Every coder googles error messages daily. Getting stuck is not failing — it is the job and your job is learning and learing is failing or breaking things.... and understanding why!!!
:::
::::
