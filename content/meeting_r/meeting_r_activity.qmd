...
*Turn this in with your worksheet. In class we split leaves at an arbitrary
weight. Now you split them at a number **you compute**, and reason about why
...
**Before running E1:** sketch the faceted plot using your mean as the cutoff.
Will the "large" and "small" panels hold roughly equal numbers of points, or
not? Guess and say why. Then run it and write whether you were right, and why
cutting at the mean behaves differently from cutting at a round number like 5.

## E3 · Interpret — ✍️ by hand, in your own words (2 pts)

1.  State the exact mean `weight_g` you computed.
2.  From your plots: does one side of the tree seem to have heavier leaves?
    Explain as if to a friend who's never seen a boxplot — describe the shapes,
    not the stats vocabulary.
3.  What would you want to test *formally* next, and why isn't eyeballing the
    boxplot enough on its own?
