...
> 💡 `position_jitter(width = 0.15)` spreads the stacked points sideways so you can see each leaf; `seed = 42` makes that spread identical every time you run it. Storing it in `jitter_pos` lets the next layer land in the exact same place.
