...
```
Missing values in Y:
Will this be a problem?  (remember
na.rm = TRUE and sum(!is.na()))
```
...
```
"I plan to use the __________ dataset, available at
__________. It contains approximately ____ rows and ____
columns. My predictor (X) is __________ and my response (Y)
is __________. My research question is: __________. My null
hypothesis is that __________, and my alternate hypothesis is
that __________. I plan to use __________ to test this. I
have confirmed I can load the file into R with read_csv()."
```
