...
:::: {.column width="40%"}
![Diagram of the pipe operator: tree_df flows down into filter(side == "sunny"), then flows down into summary(), read as "take tree_df, then filter, then summarise."](images/diagram_pipe.png){width="90%"}
...
This is why inline code is worth the syntax: your *prose* stays true to your *data* without you retyping a single number.
:::
::::
