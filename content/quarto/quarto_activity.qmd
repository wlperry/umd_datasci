...
*Turn this in with your worksheet, in the same `.qmd` you built in class. This
adds Quarto features you have **not** seen yet — cross-references and callouts.*

::: callout-important
**E2 and E3 must be handwritten** on paper, photographed, and embedded in the
report. Typed answers get **at most half credit, even if correct** — E2 is your
prediction *before* the render.
:::
