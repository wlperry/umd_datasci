---
title: "Common Code 10 — Two-Sample t-Test"
...
> ⬇️ **Download the companion R script:** [`10_ttest.R`](10_ttest.R)
...
| Boxplot + raw points | `geom_boxplot() + geom_point(position = position_jitter(width = 0.15, seed = 42), alpha = 0.4)` |
...
*End of Common Code 10 — Two-Sample t-Test.*

*Next: Common Code 11 — Correlation and regression.*
