...
type: activity
description: >
  How to do a T-Test and other r items.
...
> -   **Typing beats pasting.** Typing every line builds muscle memory and trains your eye to catch small errors (`=` vs `==`, a missing `)` or `%>%`) that you would otherwise spend real time hunting.
