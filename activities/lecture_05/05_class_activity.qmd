...
>
> Work through each part in order. Type the code into a new R script in Positron and run it line by line. Code blocks marked **▶ Run this** should be executed as written. Blocks marked **✏️ Your turn** ask you to write, modify, or interpret. The **Going further** section is optional.
