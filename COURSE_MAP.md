...
| # | Topic | Path |
|--:|-------|------|
| 01 | Libraries | `common_code/01_libraries/libraries.qmd` |
| 02 | Reading and Writing Files | `common_code/02_reading_writing/reading_writing.qmd` |
| 03 | GGPlot Basics | `common_code/03_ggplot/ggplot.qmd` |
| 04 | Filtering and Selecting Data | `common_code/04_filter_select/filter_select.qmd` |
| 05 | Mutating Data | `common_code/05_mutate/mutate.qmd` |
| 06 | Pivoting Data | `common_code/06_pivotting/pivotting.qmd` |
| 07 | Advanced Plotting | `common_code/07_advanced_plotting/advanced_plotting.qmd` |
| 08 | Themes | `common_code/08_themes/themes.qmd` |
| 09 | Descriptive Statistics | `common_code/09_desc_stats/desc_stats.qmd` |
| 10 | T-Tests | `common_code/10_ttest/ttest.qmd` |
| 11 | Correlation and Regression | `common_code/11_correlation_regression/correlation_regression.qmd` |
| 12 | One-Way ANOVA | `common_code/12_anova/anova.qmd` |
| 13 | Joins | `common_code/13_joins/joins.qmd` |
| 14 | Dates | `common_code/14_dates/dates.qmd` |
| 15 | Factors | `common_code/15_factors/factors.qmd` |
| 16 | Functions | `common_code/16_functions/functions.qmd` |
